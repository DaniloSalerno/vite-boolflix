      ...
      <div class="card" v-for="movie in this.state.movies">
        ...
        <div class="card-body">
          ...
          <div>
            ...
            <span>
              <!-- <i class="fa-solid fa-star" v-for="n in Math.round(movie.vote_average / 2)"></i></i> -->
              <font-awesome-icon icon="fa-solid fa-star" v-for="n in Math.round(movie.vote_average / 2)" />
            </span>
          </div>
